...
def print_status():
    ...
    print(f" \033[0;31mZHIFFIN\033[1;37m--\033[33mW A S B I \033[1;33m:: \033[0;32mSENT ATTACK \033[32m"+ip+"\033[0m" )
    sys.stdout.write(f"{time.ctime().split()[3]} [{str(thread_num)}]")
    print(f" \033[0;33mZHIFFIN\033[1;37m--\033[32mW A S B I \033[1;33m:: \033[97mSENT ATTACK \033[33m"+ip+"\033[0m" )
